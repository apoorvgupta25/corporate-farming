...
const {getContractById ,addContract, getContract, getAllContracts, updateContract, removeContract, documents} = require('../controllers/contract')
...
router.get('/contract/pdf/:contractId', documents);
